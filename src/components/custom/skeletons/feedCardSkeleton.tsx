...
export default function FeedCardSkeleton() {
  return (
    <Skeleton className="w-full md:w-[80%] lg:w-[60%] mx-auto bg-slate-50">
      <CardContent className="p-8 w-full -mb-8 flex justify-between items-center">
        <div className="flex justify-start items-center gap-4">
          ...
          <div className="flex flex-col justify-start items-start gap-1">
            <Skeleton className="w-[15rem] h-4 bg-slate-200" />
            <Skeleton className="w-[15rem] h-4 bg-slate-200" />
          </div>
        </div>
      </CardContent>
      <CardHeader>
        <CardTitle>
          <Skeleton className="w-[25rem] h-6 bg-slate-200" />
        </CardTitle>
        <CardDescription>
          <Skeleton className="w-full h-[4.5rem] bg-slate-200" />
        </CardDescription>
      </CardHeader>
